...
date: "2022-05"
description: "Adding dark mode — Part I: How to design for dark theme UI"
---

_Try out 🌑 dark mode ☀️ from the toggle at the top right of the navigation._
...
Dark mode for macOS allows users to auto-switch UI appearance depending on time of day
...
<figcaption>Monochrome logos are used by many top brands</figcaption>
...
<figcaption>Follow the white rabbit.</figcaption>
...
<figcaption>An old CRT monitor</figcaption>
...
![Kindle vs iPhone XS Max](./kindle-iphone.jpg)

<figcaption>

Amazon Kindle and iPhone XS Max side-by-side — [[Source]](https://appleinsider.com/articles/18/10/24/amazon-kindle-versus-iphone-xs-max-choosing-the-best-e-book-reader)
  
</figcaption>

When we observe one of the oldest forms of media: books, and their modern counterpart: ebook readers for that matter, we can start to see some correlation between them and contemporary dark mode.
